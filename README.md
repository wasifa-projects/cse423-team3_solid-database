...
## 📌 Section 1: Repository Selection & Justification (1 Mark)
...
```
## 📸 Section 2: Pre-LLM System Snapshot & Task Analysis ($H$) (2 Marks)
...
## 🤖 Section 3: LLM Prompt Design & Iterative Refinement (2 Marks)
...
## 💻 Section 4: LLM-Generated Code Quality ($L$) (1 Mark)
...
## 📊 Section 5: Metric Calculation & Accuracy (2 Marks)
...
## 🔍 Section 6: Comparative Analysis & Reflection (2 Marks)
